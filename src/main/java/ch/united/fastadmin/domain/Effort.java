...
public class Effort implements Serializable {
     ...
     */
    @ManyToOne
    @JsonIgnoreProperties(value = { "catalogService" }, allowSetters = true)
    ...
    public ReportingActivity getActivity() {
        return this.activity;
    }

    public Effort activity(ReportingActivity reportingActivity) {
        this.setActivity(reportingActivity);
        return this;
    }

    public void setActivity(ReportingActivity reportingActivity) {
        this.activity = reportingActivity;
    }
