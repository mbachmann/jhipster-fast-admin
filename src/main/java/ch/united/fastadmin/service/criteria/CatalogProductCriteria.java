...
/**
 * Criteria class for the {@link ch.united.fastadmin.domain.CatalogProduct} entity. This class is used
 * in {@link ch.united.fastadmin.web.rest.CatalogProductResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /catalog-products?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class CatalogProductCriteria implements Serializable, Criteria {
    ...
    private DoubleFilter pricePurchase;

    private DoubleFilter inventoryAvailable;

    private DoubleFilter inventoryReserved;
    ...
    private LongFilter vatId;

    public CatalogProductCriteria() {}

    public CatalogProductCriteria(CatalogProductCriteria other) {
        ...
        this.pricePurchase = other.pricePurchase == null ? null : other.pricePurchase.copy();
        this.inventoryAvailable = other.inventoryAvailable == null ? null : other.inventoryAvailable.copy();
        this.inventoryReserved = other.inventoryReserved == null ? null : other.inventoryReserved.copy();
        ...
        this.vatId = other.vatId == null ? null : other.vatId.copy();
    }

    @Override
    public CatalogProductCriteria copy() {
        return new CatalogProductCriteria(this);
    }
    ...
    public DoubleFilter getPricePurchase() {
        return pricePurchase;
    }

    public DoubleFilter pricePurchase() {
        if (pricePurchase == null) {
            pricePurchase = new DoubleFilter();
        }
        return pricePurchase;
    }

    public void setPricePurchase(DoubleFilter pricePurchase) {
        this.pricePurchase = pricePurchase;
    }

    public DoubleFilter getInventoryAvailable() {
        return inventoryAvailable;
    }

    public DoubleFilter inventoryAvailable() {
        if (inventoryAvailable == null) {
            inventoryAvailable = new DoubleFilter();
        }
        return inventoryAvailable;
    }

    public void setInventoryAvailable(DoubleFilter inventoryAvailable) {
        this.inventoryAvailable = inventoryAvailable;
    }

    public DoubleFilter getInventoryReserved() {
        return inventoryReserved;
    }

    public DoubleFilter inventoryReserved() {
        if (inventoryReserved == null) {
            inventoryReserved = new DoubleFilter();
        }
        return inventoryReserved;
    }

    public void setInventoryReserved(DoubleFilter inventoryReserved) {
    ...
    public LongFilter getVatId() {
        return vatId;
    }

    public LongFilter vatId() {
        if (vatId == null) {
            vatId = new LongFilter();
        }
        return vatId;
    }

    public void setVatId(LongFilter vatId) {
        this.vatId = vatId;
    }
    ...
    public boolean equals(Object o) {
        ...
        final CatalogProductCriteria that = (CatalogProductCriteria) o;
        return (
            ...
            Objects.equals(pricePurchase, that.pricePurchase) &&
            Objects.equals(inventoryAvailable, that.inventoryAvailable) &&
            Objects.equals(inventoryReserved, that.inventoryReserved) &&
    ...
    public String toString() {
        return "CatalogProductCriteria{" +
            ...
            (pricePurchase != null ? "pricePurchase=" + pricePurchase + ", " : "") +
            (inventoryAvailable != null ? "inventoryAvailable=" + inventoryAvailable + ", " : "") +
            (inventoryReserved != null ? "inventoryReserved=" + inventoryReserved + ", " : "") +
