...
public class ContactCriteria implements Serializable, Criteria {
    ...
    private LongFilter contactMainAddressId;
    ...
    public ContactCriteria(ContactCriteria other) {
        ...
        this.contactMainAddressId = other.contactMainAddressId == null ? null : other.contactMainAddressId.copy();
    ...
    public LongFilter getContactMainAddressId() {
        return contactMainAddressId;
    }

    public LongFilter contactMainAddressId() {
        if (contactMainAddressId == null) {
            contactMainAddressId = new LongFilter();
        }
        return contactMainAddressId;
    }

    public void setContactMainAddressId(LongFilter contactMainAddressId) {
        this.contactMainAddressId = contactMainAddressId;
    }
    ...
    public boolean equals(Object o) {
        ...
        return (
            ...
            Objects.equals(contactMainAddressId, that.contactMainAddressId) &&
    ...
    public String toString() {
        return "ContactCriteria{" +
            ...
            (contactMainAddressId != null ? "contactMainAddressId=" + contactMainAddressId + ", " : "") +
