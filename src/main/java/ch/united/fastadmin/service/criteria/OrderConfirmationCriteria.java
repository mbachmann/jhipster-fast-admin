...
/**
 * Criteria class for the {@link ch.united.fastadmin.domain.OrderConfirmation} entity. This class is used
 * in {@link ch.united.fastadmin.web.rest.OrderConfirmationResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /order-confirmations?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class OrderConfirmationCriteria implements Serializable, Criteria {
    ...
    /**
     * Class for filtering OrderConfirmationStatus
     */
    public static class OrderConfirmationStatusFilter extends Filter<OrderConfirmationStatus> {

        public OrderConfirmationStatusFilter() {}

        public OrderConfirmationStatusFilter(OrderConfirmationStatusFilter filter) {
            super(filter);
        }

        @Override
        public OrderConfirmationStatusFilter copy() {
            return new OrderConfirmationStatusFilter(this);
        }
    }
    ...
    private OrderConfirmationStatusFilter status;
    ...
    public OrderConfirmationCriteria() {}

    public OrderConfirmationCriteria(OrderConfirmationCriteria other) {
    ...
    @Override
    public OrderConfirmationCriteria copy() {
        return new OrderConfirmationCriteria(this);
    }
    ...
    public OrderConfirmationStatusFilter getStatus() {
        return status;
    }

    public OrderConfirmationStatusFilter status() {
        if (status == null) {
            status = new OrderConfirmationStatusFilter();
        }
        return status;
    }

    public void setStatus(OrderConfirmationStatusFilter status) {
        this.status = status;
    }
    ...
    public boolean equals(Object o) {
        ...
        final OrderConfirmationCriteria that = (OrderConfirmationCriteria) o;
        return (
    ...
    public String toString() {
        return "OrderConfirmationCriteria{" +
            (id != null ? "id=" + id + ", " : "") +
