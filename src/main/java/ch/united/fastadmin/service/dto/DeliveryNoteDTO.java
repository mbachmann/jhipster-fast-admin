...
/**
 * A DTO for the {@link ch.united.fastadmin.domain.DeliveryNote} entity.
 */
public class DeliveryNoteDTO implements Serializable {
     ...
     */
    @ApiModelProperty(value = "status of delivery note, possible values: DR - draft, S - sent, B - billed, D - deleted (but still visible)")
