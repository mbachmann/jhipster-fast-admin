 ...
 */
@Mapper(componentModel = "spring", uses = { CatalogCategoryMapper.class, CatalogUnitMapper.class, ValueAddedTaxMapper.class })
public interface CatalogProductMapper extends EntityMapper<CatalogProductDTO, CatalogProduct> {
    ...
    @Mapping(target = "valueAddedTax", source = "valueAddedTax", qualifiedByName = "id")
