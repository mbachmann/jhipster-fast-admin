...
public class ContactAddressResource {
    ...
    public List<ContactAddressDTO> searchContactAddresses(@RequestParam String query) {
        log.debug("REST request to search ContactAddresses for query {}", query);
        return contactAddressService.search(query);
    }
}
