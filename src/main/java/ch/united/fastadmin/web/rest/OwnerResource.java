...
import ch.united.fastadmin.service.OwnerQueryService;
...
/**
 * REST controller for managing {@link ch.united.fastadmin.domain.Owner}.
 */
@RestController
@RequestMapping("/api")
public class OwnerResource {
     ...
     */
    @GetMapping("/owners")
    public ResponseEntity<List<OwnerDTO>> getAllOwners(OwnerCriteria criteria) {
        log.debug("REST request to get Owners by criteria: {}", criteria);
        List<OwnerDTO> entityList = ownerQueryService.findByCriteria(criteria);
    ...
    public List<OwnerDTO> searchOwners(@RequestParam String query) {
