...
import com.myapp.domain.JobHistory;
import com.myapp.repository.JobHistoryRepository;
import com.myapp.service.JobHistoryService;
...
/**
 * REST controller for managing {@link com.myapp.domain.JobHistory}.
 */
@RestController
@RequestMapping("/api")
