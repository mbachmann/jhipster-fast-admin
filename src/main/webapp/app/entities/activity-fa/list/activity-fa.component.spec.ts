...
import { ActivityFaComponent } from './activity-fa.component';

describe('Component Tests', () => {
  describe('ActivityFa Management Component', () => {
    let comp: ActivityFaComponent;
    let fixture: ComponentFixture<ActivityFaComponent>;
    let service: ActivityFaService;

    beforeEach(() => {
      TestBed.configureTestingModule({
        imports: [HttpClientTestingModule],
        declarations: [ActivityFaComponent],
      })
        .overrideTemplate(ActivityFaComponent, '')
        .compileComponents();

      fixture = TestBed.createComponent(ActivityFaComponent);
