...
export interface ICatalogServiceFa {
  id?: number;
...
export class CatalogServiceFa implements ICatalogServiceFa {
  constructor(
    public id?: number,
...
export function getCatalogServiceFaIdentifier(catalogService: ICatalogServiceFa): number | undefined {
