...
export class CatalogServiceComponent implements OnInit {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.catalogServiceService
      ...
      .subscribe(
        (res: HttpResponse<ICatalogService[]>) => {
  ...
  protected onSuccess(data: ICatalogService[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
    this.totalItems = Number(headers.get('X-Total-Count'));
    this.page = page;
    if (navigate) {
      this.router.navigate(['/catalog-service'], {
        queryParams: {
          page: this.page,
          size: this.itemsPerPage,
