...
import { ContactAddressFaComponent } from './contact-address-fa.component';

describe('Component Tests', () => {
  describe('ContactAddressFa Management Component', () => {
    let comp: ContactAddressFaComponent;
    let fixture: ComponentFixture<ContactAddressFaComponent>;
    let service: ContactAddressFaService;

    beforeEach(() => {
      TestBed.configureTestingModule({
        imports: [HttpClientTestingModule],
        declarations: [ContactAddressFaComponent],
      })
        .overrideTemplate(ContactAddressFaComponent, '')
        .compileComponents();

      fixture = TestBed.createComponent(ContactAddressFaComponent);
