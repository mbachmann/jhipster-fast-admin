...
export class ContactPersonComponent implements OnInit {
  ...
  loadAll(): void {
    ...
    this.contactPersonService
      ...
      .subscribe(
        (res: HttpResponse<IContactPerson[]>) => {
  ...
  trackId(index: number, item: IContactPerson): number {
    return item.id!;
  }
  ...
  protected paginateContactPeople(data: IContactPerson[] | null, headers: HttpHeaders): void {
