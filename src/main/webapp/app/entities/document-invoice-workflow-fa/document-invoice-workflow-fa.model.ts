...
export interface IDocumentInvoiceWorkflowFa {
  id?: number;
  active?: boolean | null;
...
export class DocumentInvoiceWorkflowFa implements IDocumentInvoiceWorkflowFa {
  constructor(
    public id?: number,
...
export function getDocumentInvoiceWorkflowFaIdentifier(documentInvoiceWorkflow: IDocumentInvoiceWorkflowFa): number | undefined {
