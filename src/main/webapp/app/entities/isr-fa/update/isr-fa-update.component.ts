...
@Component({
  selector: 'fa-isr-fa-update',
  templateUrl: './isr-fa-update.component.html',
})
export class IsrFaUpdateComponent implements OnInit {
  isSaving = false;
  ...
  constructor(protected isrService: IsrFaService, protected activatedRoute: ActivatedRoute, protected fb: FormBuilder) {}
  ...
  protected subscribeToSaveResponse(result: Observable<HttpResponse<IIsrFa>>): void {
  ...
  protected updateForm(isr: IIsrFa): void {
  ...
  protected createFromForm(): IIsrFa {
    return {
      ...new IsrFa(),
