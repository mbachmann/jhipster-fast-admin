...
@Component({
  selector: 'jhl-owner-my-suffix-update',
...
export class OwnerMySuffixUpdateComponent implements OnInit {
  ...
  constructor(protected ownerService: OwnerMySuffixService, protected activatedRoute: ActivatedRoute, protected fb: FormBuilder) {}
  ...
  protected subscribeToSaveResponse(result: Observable<HttpResponse<IOwnerMySuffix>>): void {
  ...
  protected updateForm(owner: IOwnerMySuffix): void {
  ...
  protected createFromForm(): IOwnerMySuffix {
    return {
      ...new OwnerMySuffix(),
