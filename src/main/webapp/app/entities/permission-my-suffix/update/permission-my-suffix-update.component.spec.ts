...
describe('Component Tests', () => {
  describe('PermissionMySuffix Management Update Component', () => {
    ...
    describe('ngOnInit', () => {
      ...
      it('Should call ContactAddressMySuffix query and add missing value', () => {
        const permission: IPermissionMySuffix = { id: 456 };
        const contactAddress: IContactAddressMySuffix = { id: 7624 };
        permission.contactAddress = contactAddress;

        const contactAddressCollection: IContactAddressMySuffix[] = [{ id: 21036 }];
        jest.spyOn(contactAddressService, 'query').mockReturnValue(of(new HttpResponse({ body: contactAddressCollection })));
        const additionalContactAddressMySuffixes = [contactAddress];
        const expectedCollection: IContactAddressMySuffix[] = [...additionalContactAddressMySuffixes, ...contactAddressCollection];
        ...
        expect(contactAddressService.addContactAddressMySuffixToCollectionIfMissing).toHaveBeenCalledWith(
          ...
          ...additionalContactAddressMySuffixes
        );
      ...
      it('Should update editForm', () => {
        ...
        permission.contact = contact;
        const contactAddress: IContactAddressMySuffix = { id: 4987 };
        permission.contactAddress = contactAddress;
