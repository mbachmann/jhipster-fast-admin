...
describe('Component Tests', () => {
  describe('ValueAddedTax Management Component', () => {
    let comp: ValueAddedTaxComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ValueAddedTaxComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.valueAddedTaxes[0]).toEqual(expect.objectContaining({ id: 123 }));
    });
