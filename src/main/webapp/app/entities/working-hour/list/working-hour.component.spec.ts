...
describe('Component Tests', () => {
  describe('WorkingHour Management Component', () => {
    let comp: WorkingHourComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(WorkingHourComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.workingHours?.[0]).toEqual(expect.objectContaining({ id: 123 }));
    });
