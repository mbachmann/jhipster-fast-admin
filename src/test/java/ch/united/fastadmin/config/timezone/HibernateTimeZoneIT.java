package ch.united.fastadmin.config.timezone;

import static java.lang.String.format;
import static org.assertj.core.api.Assertions.assertThat;

import ch.united.fastadmin.IntegrationTest;
import ch.united.fastadmin.repository.timezone.DateTimeWrapper;
import ch.united.fastadmin.repository.timezone.DateTimeWrapperRepository;
import java.time.*;
...
class HibernateTimeZoneIT {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM jhl_date_time_wrapper where id=%d", fieldName, id);
    }
