...
class InvoiceResourceIT {
    ...
    @Test
    @Transactional
    void getAllInvoicesBySignatureIsEqualToSomething() throws Exception {
        // Initialize the database
        invoiceRepository.saveAndFlush(invoice);
        ...
        // Get all the invoiceList where signature equals to signatureId
        defaultInvoiceShouldBeFound("signatureId.equals=" + signatureId);

        // Get all the invoiceList where signature equals to (signatureId + 1)
        defaultInvoiceShouldNotBeFound("signatureId.equals=" + (signatureId + 1));
    }
