...
class OfferResourceIT {
    ...
    @Test
    @Transactional
    void getAllOffersBySignatureIsEqualToSomething() throws Exception {
        // Initialize the database
        offerRepository.saveAndFlush(offer);
        ...
        // Get all the offerList where signature equals to signatureId
        defaultOfferShouldBeFound("signatureId.equals=" + signatureId);

        // Get all the offerList where signature equals to (signatureId + 1)
        defaultOfferShouldNotBeFound("signatureId.equals=" + (signatureId + 1));
    }
