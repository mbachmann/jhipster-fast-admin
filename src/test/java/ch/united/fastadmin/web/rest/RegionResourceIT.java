...
import ch.united.fastadmin.domain.Region;
import ch.united.fastadmin.repository.RegionRepository;
import ch.united.fastadmin.repository.search.RegionSearchRepository;
import ch.united.fastadmin.service.dto.RegionDTO;
import ch.united.fastadmin.service.mapper.RegionMapper;
...
class RegionResourceIT {
     ...
     *
     * @see ch.united.fastadmin.repository.search.RegionSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    void searchRegion() throws Exception {
        ...
        // Initialize the database
        regionRepository.saveAndFlush(region);
        when(mockRegionSearchRepository.search(queryStringQuery("id:" + region.getId()))).thenReturn(Collections.singletonList(region));
