...
describe('CatalogProduct e2e test', () => {
  const catalogProductPageUrl = '/catalog-product-fa';
  const catalogProductPageUrlPattern = new RegExp('/catalog-product-fa(\\?.*)?$');
  ...
  it('should load CatalogProducts', () => {
    cy.visit('/');
    cy.clickOnEntityMenuItem('catalog-product-fa');
  ...
  it('should create an instance of CatalogProduct', () => {
    ...
    cy.get(`[data-cy="created"]`).type('2021-08-17T03:51').should('have.value', '2021-08-17T03:51');
