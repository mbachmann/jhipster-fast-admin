...
describe('CatalogService e2e test', () => {
  const catalogServicePageUrl = '/catalog-service-fa';
  const catalogServicePageUrlPattern = new RegExp('/catalog-service-fa(\\?.*)?$');
  ...
  it('should load CatalogServices', () => {
    cy.visit('/');
    cy.clickOnEntityMenuItem('catalog-service-fa');
  ...
  it('should create an instance of CatalogService', () => {
    ...
    cy.get(`[data-cy="created"]`).type('2021-08-17T03:10').should('have.value', '2021-08-17T03:10');
    ...
    cy.setFieldSelectToLastOfEntity('vat');
