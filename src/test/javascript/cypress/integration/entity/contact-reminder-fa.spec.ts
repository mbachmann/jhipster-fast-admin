...
describe('ContactReminder e2e test', () => {
  const contactReminderPageUrl = '/contact-reminder-fa';
  const contactReminderPageUrlPattern = new RegExp('/contact-reminder-fa(\\?.*)?$');
  ...
  it('should load ContactReminders', () => {
    cy.visit('/');
    cy.clickOnEntityMenuItem('contact-reminder-fa');
  ...
  it('should create an instance of ContactReminder', () => {
    ...
    cy.get(`[data-cy="dateTime"]`).type('2021-08-05T10:11').should('have.value', '2021-08-05T10:11');
