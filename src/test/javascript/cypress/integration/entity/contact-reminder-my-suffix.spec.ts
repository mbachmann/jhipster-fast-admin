...
describe('ContactReminder e2e test', () => {
  const contactReminderPageUrl = '/contact-reminder-my-suffix';
  const contactReminderPageUrlPattern = new RegExp('/contact-reminder-my-suffix(\\?.*)?$');
  ...
  it('should load ContactReminders', () => {
    cy.visit('/');
    cy.clickOnEntityMenuItem('contact-reminder-my-suffix');
  ...
  it('should create an instance of ContactReminder', () => {
    ...
    cy.get(`[data-cy="dateTime"]`).type('2021-08-05T09:42').should('have.value', '2021-08-05T09:42');
