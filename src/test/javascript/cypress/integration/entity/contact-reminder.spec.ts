...
describe('ContactReminder e2e test', () => {
  ...
  it('should create an instance of ContactReminder', () => {
    ...
    cy.get(`[data-cy="description"]`).type('Walk Re-contextualized').should('have.value', 'Walk Re-contextualized');

    cy.get(`[data-cy="intervalValue"]`).type('17101').should('have.value', '17101');

    cy.get(`[data-cy="intervalType"]`).select('MONTH');
