...
describe('DeliveryNote e2e test', () => {
  const deliveryNotePageUrl = '/delivery-note-fa';
  const deliveryNotePageUrlPattern = new RegExp('/delivery-note-fa(\\?.*)?$');
  ...
  it('should load DeliveryNotes', () => {
    cy.visit('/');
    cy.clickOnEntityMenuItem('delivery-note-fa');
  ...
  it('should create an instance of DeliveryNote', () => {
    ...
    cy.get(`[data-cy="created"]`).type('2021-08-16T13:14').should('have.value', '2021-08-16T13:14');
