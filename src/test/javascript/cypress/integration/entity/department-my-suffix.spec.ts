...
describe('Department e2e test', () => {
  const departmentPageUrl = '/department-my-suffix';
  const departmentPageUrlPattern = new RegExp('/department-my-suffix(\\?.*)?$');
  ...
  it('should load Departments', () => {
    cy.visit('/');
    cy.clickOnEntityMenuItem('department-my-suffix');
