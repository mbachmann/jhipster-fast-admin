...
describe('DescriptiveDocumentText e2e test', () => {
  const descriptiveDocumentTextPageUrl = '/descriptive-document-text-fa';
  const descriptiveDocumentTextPageUrlPattern = new RegExp('/descriptive-document-text-fa(\\?.*)?$');
  ...
  it('should load DescriptiveDocumentTexts', () => {
    cy.visit('/');
    cy.clickOnEntityMenuItem('descriptive-document-text-fa');
