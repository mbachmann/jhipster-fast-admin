...
describe('DocumentLetter e2e test', () => {
  const documentLetterPageUrl = '/document-letter-fa';
  const documentLetterPageUrlPattern = new RegExp('/document-letter-fa(\\?.*)?$');
  ...
  it('should load DocumentLetters', () => {
    cy.visit('/');
    cy.clickOnEntityMenuItem('document-letter-fa');
  ...
  it('should create an instance of DocumentLetter', () => {
    ...
    cy.get(`[data-cy="created"]`).type('2021-08-16T18:05').should('have.value', '2021-08-16T18:05');
