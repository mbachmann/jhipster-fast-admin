...
describe('Effort e2e test', () => {
  const effortPageUrl = '/effort';
  const effortPageUrlPattern = new RegExp('/effort(\\?.*)?$');
  ...
  it('should load Efforts', () => {
    cy.visit('/');
    cy.clickOnEntityMenuItem('effort');
  ...
  it('should create an instance of Effort', () => {
    ...
    cy.get(`[data-cy="updated"]`).type('2021-08-16T18:00').should('have.value', '2021-08-16T18:00');
