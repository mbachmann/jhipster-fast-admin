...
describe('Employee e2e test', () => {
  const employeePageUrl = '/employee-my-suffix';
  const employeePageUrlPattern = new RegExp('/employee-my-suffix(\\?.*)?$');
  ...
  it('should load Employees', () => {
    cy.visit('/');
    cy.clickOnEntityMenuItem('employee-my-suffix');
  ...
  it('should create an instance of Employee', () => {
    ...
    cy.get(`[data-cy="hireDate"]`).type('2021-08-03T21:00').should('have.value', '2021-08-03T21:00');
