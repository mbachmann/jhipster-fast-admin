...
describe('ExchangeRate e2e test', () => {
  const exchangeRatePageUrl = '/exchange-rate-fa';
  const exchangeRatePageUrlPattern = new RegExp('/exchange-rate-fa(\\?.*)?$');
  ...
  it('should load ExchangeRates', () => {
    cy.visit('/');
    cy.clickOnEntityMenuItem('exchange-rate-fa');
  ...
  it('should create an instance of ExchangeRate', () => {
    ...
    cy.get(`[data-cy="created"]`).type('2021-08-17T08:04').should('have.value', '2021-08-17T08:04');
