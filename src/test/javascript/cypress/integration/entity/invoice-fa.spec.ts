...
describe('Invoice e2e test', () => {
  const invoicePageUrl = '/invoice-fa';
  const invoicePageUrlPattern = new RegExp('/invoice-fa(\\?.*)?$');
  ...
  it('should load Invoices', () => {
    cy.visit('/');
    cy.clickOnEntityMenuItem('invoice-fa');
  ...
  it('should create an instance of Invoice', () => {
    ...
    cy.get(`[data-cy="created"]`).type('2021-08-17T12:45').should('have.value', '2021-08-17T12:45');
