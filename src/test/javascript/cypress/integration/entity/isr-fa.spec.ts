...
describe('Isr e2e test', () => {
  const isrPageUrl = '/isr-fa';
  const isrPageUrlPattern = new RegExp('/isr-fa(\\?.*)?$');
  ...
  it('should load Isrs', () => {
    cy.visit('/');
    cy.clickOnEntityMenuItem('isr-fa');
  ...
  it('should create an instance of Isr', () => {
    ...
    cy.get(`[data-cy="created"]`).type('2021-08-16T14:11').should('have.value', '2021-08-16T14:11');
