...
describe('JobHistory e2e test', () => {
  ...
  it('should create an instance of JobHistory', () => {
    ...
    cy.get(`[data-cy="startDate"]`).type('2021-08-04T13:10').should('have.value', '2021-08-04T13:10');

    cy.get(`[data-cy="endDate"]`).type('2021-08-04T03:19').should('have.value', '2021-08-04T03:19');
