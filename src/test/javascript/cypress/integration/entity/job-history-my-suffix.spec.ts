...
describe('JobHistory e2e test', () => {
  const jobHistoryPageUrl = '/job-history-my-suffix';
  const jobHistoryPageUrlPattern = new RegExp('/job-history-my-suffix(\\?.*)?$');
  ...
  it('should load JobHistories', () => {
    cy.visit('/');
    cy.clickOnEntityMenuItem('job-history-my-suffix');
  ...
  it('should create an instance of JobHistory', () => {
    ...
    cy.get(`[data-cy="startDate"]`).type('2021-08-04T19:53').should('have.value', '2021-08-04T19:53');

    cy.get(`[data-cy="endDate"]`).type('2021-08-04T10:01').should('have.value', '2021-08-04T10:01');
