...
describe('JobHistory e2e test', () => {
  ...
  it('should create an instance of JobHistory', () => {
    ...
    cy.get(`[data-cy="startDate"]`).type('2021-08-04T09:42').should('have.value', '2021-08-04T09:42');

    cy.get(`[data-cy="endDate"]`).type('2021-08-03T23:51').should('have.value', '2021-08-03T23:51');
