...
describe('Offer e2e test', () => {
  const offerPageUrl = '/offer-fa';
  const offerPageUrlPattern = new RegExp('/offer-fa(\\?.*)?$');
  ...
  it('should load Offers', () => {
    cy.visit('/');
    cy.clickOnEntityMenuItem('offer-fa');
  ...
  it('should create an instance of Offer', () => {
    ...
    cy.get(`[data-cy="created"]`).type('2021-08-17T00:07').should('have.value', '2021-08-17T00:07');
