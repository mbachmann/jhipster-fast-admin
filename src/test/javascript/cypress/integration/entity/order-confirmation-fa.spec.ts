...
describe('OrderConfirmation e2e test', () => {
  const orderConfirmationPageUrl = '/order-confirmation-fa';
  const orderConfirmationPageUrlPattern = new RegExp('/order-confirmation-fa(\\?.*)?$');
  ...
  it('should load OrderConfirmations', () => {
    cy.visit('/');
    cy.clickOnEntityMenuItem('order-confirmation-fa');
  ...
  it('should create an instance of OrderConfirmation', () => {
    ...
    cy.get(`[data-cy="created"]`).type('2021-08-17T09:32').should('have.value', '2021-08-17T09:32');
