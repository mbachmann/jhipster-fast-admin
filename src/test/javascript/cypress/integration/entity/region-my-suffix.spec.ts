...
describe('Region e2e test', () => {
  const regionPageUrl = '/region-my-suffix';
  const regionPageUrlPattern = new RegExp('/region-my-suffix(\\?.*)?$');
  ...
  it('should load Regions', () => {
    cy.visit('/');
    cy.clickOnEntityMenuItem('region-my-suffix');
  ...
  it('should create an instance of Region', () => {
    ...
    cy.get(`[data-cy="regionName"]`).type('flexibility composite attitude').should('have.value', 'flexibility composite attitude');
